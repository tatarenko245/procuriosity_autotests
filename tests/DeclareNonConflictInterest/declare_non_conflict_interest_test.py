...
class TestDeclareNonConflictInterest:
    ...
    def test_check_result_of_sending_the_request_two(self):
        ...
        with allure.step(f'# {step_number}. Authorization platform one: create second Bid'):
            ...
            step_number += 1
        with allure.step(f'# {step_number}. Send request for create second Bid'):
            """
            ...
            for y in range(len(tenderers_list)):
                ...
                with allure.step(f'# {step_number}. See result'):
                    ...
                    with allure.step(f'# {step_number}.3. Check MS release'):
                        ...
                        if n != 1:
                            iterable_item_added_object.update(previous_value_of_iterable_item_object)
                        ...
                        previous_value_of_iterable_item_object = copy.deepcopy(expected_result['iterable_item_added'])
    ...
    @allure.title("Изменить решение по декларации\n"
                  "------------------------------------------------\n"
                  "Баг https://ustudio.atlassian.net/browse/ES-6461\n"
                  "================================================\n"
                  "EI: full data model with items array;\n"
                  "FS: full data model, own money;\n"
                  "PN: full data model, 1 lots, 1 items;\n"
    ...
    def test_check_result_of_sending_the_request_four(self):
        ...
        for x in range(len(requirements_list)):
            for y in range(len(tenderers_list)):
                ...
                with allure.step(f'# {step_number}.Authorization platform one: update declare '
                                 f'non conflict interest'):
                    """
                    ...
                    GlobalClassCreateDeclareNonConflict.operation_id = PlatformAuthorization(
                        ...
                        GlobalClassCreateDeclareNonConflict.access_token)
                    step_number += 1
                with allure.step(f'# {step_number}. Send request for update declare non conflict interest'):
                    """
        ...
        for x in range(len(requirements_list)):
            for y in range(len(tenderers_list)):
                ...
                with allure.step(f'# {step_number}. See result'):
                    ...
                    Check the results of test case running.
                    """
                    with allure.step(f'# {step_number}.1. Check message in feed point after declaration creating'):
                        """
                        Check the asynchronous_result_of_sending_the_request.
                        """
                        time.sleep(1)
                    ...
                    with allure.step(f'# {step_number}.2. Check EV release after declaration creating'):
                        """
                        Compare actual evaluation value release with expected evaluation value release model.
                        """
                        time.sleep(2)
                    ...
                    with allure.step(f'# {step_number}.3. Check MS release after declaration creating'):
                        """
                        Compare multistage release with expected multistage release model.
                        """
                        time.sleep(2)
                    ...
                    with allure.step(f'# {step_number}.1. Check message in feed point after declaration updating'):
                        """
                        Check the asynchronous_result_of_sending_the_request.
                        """
                        time.sleep(1)
                    ...
                    with allure.step(f'# {step_number}.2. Check EV release after declaration updating'):
                        """
                        Compare actual evaluation value release with expected evaluation value release model.
                        """
                        time.sleep(2)
                    ...
                    with allure.step(f'# {step_number}.3. Check MS release after declaration updating'):
                        """
                        Compare multistage release with expected multistage release model.
                        """
                        time.sleep(2)
