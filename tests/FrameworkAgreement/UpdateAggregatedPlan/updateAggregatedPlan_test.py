...
class TestUpdateAggregatedPlan:
    ...
    def test_case_1(self, get_hosts, parse_country, parse_language, parse_pmd, parse_environment,
        ...
        step_number += 1
        with allure.step(f'# {step_number}. See result of UpdateAp process.'):
            """
            ...
            with allure.step(f'# {step_number}.2. Check the message for the platform, '
                             f'the UpdateAggregatedPlan process.'):
                """
                ...
                with allure.step('Compare actual and expected message for platform.'):
                    ...
                    processId = CassandraSession().get_process_id_by_operation_id(connect_to_ocds, updateAp_operationId)
