...
from tests.utils.ReleaseModels.SelectiveProcedure.QualificationProtocol.qualification_protocol_release import \
            ...
            with allure.step(f'# {step_number}.4. Check MS release'):
                ...
                try:
                    ...
                    if compare_releases == expected_result:
                        ...
                        connect_to_database.apply_qualification_protocol_process_cleanup_table_of_services(
                            pn_ocid=pn_ocid)
