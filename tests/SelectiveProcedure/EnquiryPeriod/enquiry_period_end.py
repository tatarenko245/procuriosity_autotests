...
from tests.utils.PayloadModel.RestrictedProcedure.EnquiryPeriod.answer_prepared_payload import AnswerPreparePayload
from tests.utils.PayloadModel.RestrictedProcedure.EnquiryPeriod.enquiry_prepared_payload import EnquiryPreparePayload
        ...
        with allure.step(f'# {step_number}. See result'):
            ...
            with allure.step(f'# {step_number}.3. Check TP release'):
                ...
                try:
                    ...
                    """
                    extension_after_unsuspended = int(connection_to_database.get_min_submission_period_duration_rules(
                        country=country,
                        pmd=pmd,
                        operation_type='all',
