            ...
            with allure.step(f'# {step_number}.4. Check MS release'):
                ...
                try:
                    ...
                    if compare_releases == expected_result:
                        ...
                        connect_to_database.cleanup_ocds_orchestrator_operation_step_by_operation_id(operation_id=create_enquiry_operation_id)
                    else:
                        with allure.step('# Steps from Casandra DataBase'):
                            steps = connect_to_database.get_bpe_operation_step_by_operation_id(
                ...
                expected_result = {
                    ...
                    "values_changed": {
                        ...
                        "root['releases'][0]['tender']['enquiryPeriod']['endDate']": {
                            "new_value": Date().selectiveProcedure_enquiryPeriod_endDate_after_unsuspended(
                        ...
                        "root['releases'][0]['preQualification']['period']['endDate']": {
                            "new_value": Date().selectiveProcedure_preQualificationPeriod_endDate_after_unsuspended(
                                create_answer_date=create_answer_feed_point_message['data']['operationDate'],
