...
from tests.utils.ReleaseModels.LimitedProcedure.Pn.pn_prepared_release import PnExpectedRelease
        ...
        with allure.step(f'# {step_number}. See result'):
            ...
            with allure.step(f'# {step_number}.5. Check ExpenditureItem release'):
                ...
                allure.attach(str(json.dumps(actual_ei_release_after_fs_creation)),
                              "Actual ExpenditureItem release before pn creating")
            ...
            with allure.step(f'# {step_number}.6. Check FinancialSource release'):
                ...
                allure.attach(str(json.dumps(actual_fs_release_before_pn_creation)),
                              "Actual FinancialSource release before pn creating")
