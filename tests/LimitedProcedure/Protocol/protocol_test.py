...
from tests.utils.ReleaseModels.LimitedProcedure.Protocol.protocol_releases import ProtocolReleases
                ...
                with allure.step('Check a difference of comparing Ms release before Protocol and '
                    ...
                    try:
                        ...
                        if compare_releases == expected_result:
                            ...
                            connect_to_database.cleanup_ocds_orchestrator_operation_step_by_operation_id(operation_id=createEi_operationId)

                            connect_to_database.cleanup_ocds_orchestrator_operation_step_by_operation_id(operation_id=createFs_operationId)

                            connect_to_database.cleanup_ocds_orchestrator_operation_step_by_operation_id(operation_id=createPn_operationId)

                            connect_to_database.cleanup_ocds_orchestrator_operation_step_by_operation_id(operation_id=createCn_operationId)
