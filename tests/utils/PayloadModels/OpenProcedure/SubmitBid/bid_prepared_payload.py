...
from tests.utils.data_of_enum import scale_tuple, documentType_for_bid_tuple, person_title_tuple, type_of_supplier_tuple
...
class BidPreparePayload:
    ...
    def create_first_bid_full_data_model_with_requirement_responses(
        ...
        payload['bid']['tenderers'][0]['persones'][0]['title'] = f"{random.choice(person_title_tuple)}"
        ...
        payload['bid']['tenderers'][0]['persones'][1]['title'] = f"{random.choice(person_title_tuple)}"
        ...
        payload['bid']['tenderers'][0]['details']['typeOfSupplier'] = f"{random.choice(type_of_supplier_tuple)}"
        ...
        payload['bid']['tenderers'][0]['details']['scale'] = f"{random.choice(scale_tuple)}"
        ...
        payload['bid']['tenderers'][1]['persones'][0]['title'] = f"{random.choice(person_title_tuple)}"
        ...
        payload['bid']['tenderers'][1]['persones'][1]['title'] = f"{random.choice(person_title_tuple)}"
        ...
        payload['bid']['tenderers'][1]['details']['typeOfSupplier'] = f"{random.choice(type_of_supplier_tuple)}"
        ...
        payload['bid']['tenderers'][1]['details']['scale'] = f"{random.choice(scale_tuple)}"
        ...
        payload['bid']['documents'][0]['documentType'] = f"{random.choice(documentType_for_bid_tuple)}"
        ...
        payload['bid']['documents'][1]['documentType'] = f"{random.choice(documentType_for_bid_tuple)}"
