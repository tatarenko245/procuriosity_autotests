...
from tests.utils.PayloadModels.OpenProcedure.EvaluateAward.evaluate_award_library import PayloadLibrary
from tests.utils.data_of_enum import documentType_for_evaluate_award_tuple
...
class EvaluateAwardPreparePayload:
    ...
    def create_evaluate_award_full_data_model(self, award_status_details, based_stage_release):
        ...
        payload['award']['documents'][0]['documentType'] = f"{random.choice(documentType_for_evaluate_award_tuple)}"
