...
from tests.utils.PayloadModels.OpenProcedure.EnquiryPeriod.enquiry_payload_library import PayloadLibrary
from tests.utils.data_of_enum import locality_scheme_tuple, scale_tuple
...
class EnquiryPreparePayload:
    ...
    def create_enquiry_full_data_model(self, based_stage_release):
        ...
        payload['enquiry']['author']['address']['addressDetails']['locality']['scheme'] = \
            random.choice(locality_scheme_tuple)
        ...
        payload['enquiry']['author']['details']['scale'] = random.choice(scale_tuple)
