...
from tests.utils.PayloadModels.OpenProcedure.CnOnPn.cnonpn_payload_library import PayloadLibrary
...
from tests.utils.data_of_enum import cpv_goods_low_level_03_tuple, cpv_goods_low_level_1_tuple, cpv_goods_low_level_2_tuple, \
    ...
    cpv_services_low_level_92_tuple, cpv_services_low_level_98_tuple, documentType_tuple, person_title_tuple
...
class CnOnPnPreparePayload:
    def __init__(self, get_hosts, country, language):
        ...
        self.standard_criteria = MdmService(host_to_service=self.get_hosts[2]).get_standard_criteria(
    ...
    def create_cnonpn_full_data_model_with_lots_items_documents_criteria_conv_auction(
        ...
        payload['tender']['procuringEntity']['persones'][0]['title'] = f"{random.choice(person_title_tuple)}"
        ...
        payload['tender']['documents'][0]['documentType'] = f"{random.choice(documentType_tuple)}"
        ...
        payload['tender']['documents'][1]['documentType'] = f"{random.choice(documentType_tuple)}"
