...
from tests.utils.PayloadModels.OpenProcedure.Pn.pn_payload_library import PayloadLibrary

from tests.utils.data_of_enum import legalBasis_tuple, cpv_goods_low_level_03_tuple, cpv_goods_low_level_1_tuple, cpv_goods_low_level_2_tuple, \
    ...
    cpv_services_low_level_92_tuple, cpv_services_low_level_98_tuple, documentType_tuple
...
class PnPreparePayload:
    ...
    def create_pn_obligatory_data_model_without_lots_and_items_based_on_one_fs(self):
        ...
        payload['tender']['legalBasis'] = f"{random.choice(legalBasis_tuple)}"
