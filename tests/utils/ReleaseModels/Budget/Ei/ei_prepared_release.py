...
class EiExpectedRelease:
    def __init__(self, environment, language, ei_payload, ei_feed_point_message, actual_ei_release):
        self.environment = environment
        self.language = language
        self.ei_payload = ei_payload
        self.ei_ocid = ei_feed_point_message["data"]["outcomes"]["ei"][0]['id']
        self.ei_feed_point_message = ei_feed_point_message
    ...
    def prepare_expected_items_array(self):
        payload_items_array = self.ei_payload['tender']['items']
        release_items_array = self.actual_ei_release['releases'][0]['tender']['items']
    ...
    def ei_release_full_data_model(self):
        release_id = self.actual_ei_release['releases'][0]['id']
        tender_id = self.actual_ei_release['releases'][0]['tender']['id']
        ...
        try:
            if self.ei_payload['tender']['classification']['id'][0:2] == "03" or \
                    self.ei_payload['tender']['classification']['id'][0] == "1" or \
                    self.ei_payload['tender']['classification']['id'][0] == "2" or \
                    self.ei_payload['tender']['classification']['id'][0] == "3" or \
                    self.ei_payload['tender']['classification']['id'][0:2] == "44" or \
                    self.ei_payload['tender']['classification']['id'][0:2] == "48":
                self.main_procurement_category = "goods"
            elif self.ei_payload['tender']['classification']['id'][0:2] == "45":
                self.main_procurement_category = "works"
            elif self.ei_payload['tender']['classification']['id'][0] == "5" or \
                    self.ei_payload['tender']['classification']['id'][0] == "6" or \
                    self.ei_payload['tender']['classification']['id'][0] == "7" or \
                    self.ei_payload['tender']['classification']['id'][0] == "8" or \
                    self.ei_payload['tender']['classification']['id'][0:2] == "92" or \
                    self.ei_payload['tender']['classification']['id'][0:2] == "98":
        ...
        try:
            ...
            if self.ei_payload['buyer']['address']['addressDetails']['locality']['scheme'] == "CUATM":
                ...
                buyer_locality_object = {
                    ...
                    "id": self.ei_payload['buyer']['address']['addressDetails']['locality']['id'],
                    "description": self.ei_payload['buyer']['address']['addressDetails']['locality'][
                        'description']
                }
        except ValueError:
        ...
        try:
            tender_classification_id = get_value_from_classification_cpv_dictionary_xls(
                self.ei_payload['tender']['classification']['id'], self.language)
        except ValueError:
            raise ValueError("Check tender.classification.id")

        release['uri'] = f"{self.metadata_budget_url}/{self.ei_ocid}/{self.ei_ocid}"
        release['version'] = "1.1"
        ...
        release['publishedDate'] = self.ei_feed_point_message['data']['operationDate']
        release['releases'][0]['ocid'] = self.ei_ocid
        release['releases'][0]['id'] = f"{self.ei_ocid}-{release_id[29:42]}"
        release['releases'][0]['date'] = self.ei_feed_point_message['data']['operationDate']
        ...
        release['releases'][0]['tender']['title'] = self.ei_payload['tender']['title']
        release['releases'][0]['tender']['description'] = self.ei_payload['tender']['description']
        ...
        release['releases'][0]['buyer']['id'] = \
            f"{self.ei_payload['buyer']['identifier']['scheme']}-" \
            f"{self.ei_payload['buyer']['identifier']['id']}"
        release['releases'][0]['buyer']['name'] = self.ei_payload['buyer']['name']
        release['releases'][0]['parties'][0]['id'] = \
            f"{self.ei_payload['buyer']['identifier']['scheme']}-" \
            f"{self.ei_payload['buyer']['identifier']['id']}"
        release['releases'][0]['parties'][0]['name'] = self.ei_payload['buyer']['name']
        release['releases'][0]['parties'][0]['identifier']['scheme'] = \
            self.ei_payload['buyer']['identifier']['scheme']
        release['releases'][0]['parties'][0]['identifier']['id'] = \
            self.ei_payload['buyer']['identifier']['id']
        release['releases'][0]['parties'][0]['identifier']['legalName'] = \
            self.ei_payload['buyer']['identifier']['legalName']
        release['releases'][0]['parties'][0]['identifier']['uri'] = \
            self.ei_payload['buyer']['identifier']['uri']
        release['releases'][0]['parties'][0]['address']['streetAddress'] = \
            self.ei_payload['buyer']['address']['streetAddress']
        release['releases'][0]['parties'][0]['address']['postalCode'] = \
            self.ei_payload['buyer']['address']['postalCode']
        ...
        release['releases'][0]['parties'][0]['additionalIdentifiers'] = \
            self.ei_payload['buyer']['additionalIdentifiers']
        release['releases'][0]['parties'][0]['contactPoint']['name'] = \
            self.ei_payload['buyer']['contactPoint']['name']
        release['releases'][0]['parties'][0]['contactPoint']['telephone'] = \
            self.ei_payload['buyer']['contactPoint']['telephone']
        release['releases'][0]['parties'][0]['contactPoint']['email'] = \
            self.ei_payload['buyer']['contactPoint']['email']
        release['releases'][0]['parties'][0]['contactPoint']['faxNumber'] = \
            self.ei_payload['buyer']['contactPoint']['faxNumber']
        release['releases'][0]['parties'][0]['contactPoint']['url'] = \
            self.ei_payload['buyer']['contactPoint']['url']
        release['releases'][0]['parties'][0]['details'] = self.ei_payload['buyer']['details']
        ...
        release['releases'][0]['planning']['rationale'] = self.ei_payload['planning']['rationale']
        return release
