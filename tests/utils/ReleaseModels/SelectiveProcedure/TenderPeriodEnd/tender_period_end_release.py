...
from tests.utils.ReleaseModels.SelectiveProcedure.TenderPeriodEnd.tender_period_end_release_library import ReleaseLibrary
...
class TenderPeriodExpectedChanges:
    def __init__(self, environment, language, host_for_services):
        ...
        self.mdm = MdmService(host_to_service=host_for_services)
