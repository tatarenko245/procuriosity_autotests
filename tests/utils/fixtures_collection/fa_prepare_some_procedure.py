...
from tests.FrameworkAgreement.CreateSubmission.createSubmission_test import TestCreateSubmission
...
def presets(get_hosts, parse_country, parse_language, parse_pmd, parse_environment,
    ...
    return get_hosts, parse_country, parse_language, parse_pmd, parse_environment, \
           prepare_tender_classification_id, connect_to_ocds, connect_to_access, connect_to_orchestrator, \
           connect_to_clarification, connect_to_dossier


@pytest.fixture(scope="function")
def create_submission_tc_1():
    step_number = 1
