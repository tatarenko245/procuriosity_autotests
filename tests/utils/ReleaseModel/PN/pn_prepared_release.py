    ...
    def __init__(self, environment, language):
        ...
        try:
            if environment == "dev":
                ...
                self.metadata_document_url = "https://dev.storage.eprocurement.systems/api/v1/storage/get"
                ...
                self.metadata_document_url = "https://storage.eprocurement.systems/api/v1/storage/get"
        except ValueError:
