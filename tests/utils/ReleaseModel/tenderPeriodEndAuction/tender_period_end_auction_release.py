...
class TenderPeriodExpectedChanges:
    ...
    def prepare_unsuccessful_awards_array(self, feed_point_message):
        ...
        try:
            ...
            for i in GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender']['lots']:
                for i_1 in i:
                    if i_1 == "id":
    ...
    def prepare_array_of_awards_mapper(self, bid_payload, feed_point_message):
        ...
        try:
            ...
            for bl in related_lots_array:
                for li in GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender']['lots']:
                    if li['id'] == bl:
                        if li['status'] == "active":
        ...
        try:
            ...
            for al in range(quantity_of_lots_have_active_status):
                ...
                if "criteria" in GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender']:
                    try:
                        """
                        ...
                        """
                        award_criteria = GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender'][
                            'awardCriteria']
                        award_criteria_details = GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0][
                ...
                try:
                    ...
                    successful_award_object['id'] = \
                        GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['awards'][al]['id']
                except Exception:
                    raise Exception("Impossible to check how many quantity of object into "
