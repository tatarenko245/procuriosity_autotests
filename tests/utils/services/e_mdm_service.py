...
class MdmService:
    def __init__(self, host_to_service, environment):
        self.port = HttpManager().e_mdm_service()[0]
        self.host = host_to_service
        self.environment = environment

    def get_standard_criteria(self, country, language):
        url = None
    ...
    def __del__(self):
        print(f"The instance of MdmService class: {__name__} was deleted.")
