...
class KafkaMessage:
    ...
    @staticmethod
    def protocol_message_is_successful(environment, kafka_message, pn_ocid, ev_id):
        tender_url = None
                    ...
                    if i_1 == "id":
                        ...
                        if check_can_id is True:
                            ...
                            log_msg_one = f"\n{datetime.datetime.now()}\n" \
                                          f"File = kafka_message.py -> \n" \
                                          f"Class = KafkaMessage -> \n" \
                                          f"Method = protocol_message_is_successful -> \n" \
                                          f"Actual result: check_can_id = {i['id']} is not correct.\n" \
                                          f"Expected result: actual result must be UUID v.4\n"
                            with open(f'{get_project_root()}/logfile.txt', 'a') as logfile:
                                logfile.write(log_msg_one)
                            return False
                    ...
                    if i_1 == "X-TOKEN":
                        ...
                        if check_can_token is True:
                            ...
                            log_msg_one = f"\n{datetime.datetime.now()}\n" \
                                          ...
                                          f"Class = KafkaMessage -> \n" \
                                          f"Method = protocol_message_is_successful -> \n" \
                                          f"Actual result: check_can_token = {i['X-TOKEN']} " \
                                          f"is not correct.\n" \
                                          f"Expected result: actual result must be UUID v.4\n"
                            with open(f'{get_project_root()}/logfile.txt', 'a') as logfile:
                                logfile.write(log_msg_one)
                ...
                for i_1 in i:
                    ...
                    if i_1 == "X-TOKEN":
                        ...
                        if check_qualification_token is True:
                            ...
                            raise ("check_qualification_token is False")
        except KeyError:
