...
class TestCreateFs:
    ...
    def test_check_status_code_and_message_from_kafka_topic_after_fs_creation(self, environment, country, language,
        ...
        with allure.step('# 4. Send request to create FS'):
            GlobalClassCreateFs.payload_for_create_fs = payload.create_fs_full_data_model()
    ...
    @allure.title('Check FS release data after FS creation:'
                  ...
                  'and fs -> full data model')
    def test_check_fs_release_data_after_fs_creation_ei_model_without_optional_fields_and_fs_full_data_model(
