...
class TestCreatePn:
    def test_setup(self, environment, country, language, pmd, cassandra_username, cassandra_password):
        ...
        """
        print(environment, country, language, pmd, cassandra_username, cassandra_password)
    ...
    @allure.title('Check status code and message from Kafka topic after Bid creating')
