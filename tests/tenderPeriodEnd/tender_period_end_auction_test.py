    ...
    def test_check_result_of_sending_the_request_six(self):
        ...
        with allure.step('# 13. See result'):
            ...
            with allure.step('# 13.2. Check EV release'):
                ...
                print("Expected release")
                print(json.dumps(expected_result))

                print("Actual awards")
                print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['awards']))
                print("Expected awards")
                print(json.dumps(final_expected_awards_array))

                print("Actual parties")
                print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['parties']))
                print("Expected parties")
                print(json.dumps(final_expected_parties_array))

                print("Actual bids")
                print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['bids']))
                print("Expected bids")
                print(json.dumps(final_expected_bids_object))

                print("Actual awardPeriod")
                print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender'][
                                     'awardPeriod']))
                print("Expected awardPeriod")
                print(json.dumps(final_expected_award_period_object))

                print("Actual criteria")
                print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender'][
                                     'criteria'][final_expected_criteria_array[1]]))
                print("Expected criteria")
                print(json.dumps(final_expected_criteria_array[0]))
                print("quantity")
                print(final_expected_criteria_array[1])
