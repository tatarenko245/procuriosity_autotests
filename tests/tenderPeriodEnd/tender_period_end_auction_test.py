...
class TestCreateBid:
    ...
    #         print("GlobalClassCreatePn.payload")
        ...
        with allure.step('# 11. See result'):
            ...
            with allure.step('# 11.1. Check message in feed point'):
                ...
                with allure.step('# 11.2. Check EV release'):
                    ...
                    print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release[
                                         'releases'][0]['parties']))
                    ...
                    print("-----------------------------------------")
                    print("Actual bids object")
                    print(json.dumps(GlobalClassTenderPeriodEndAuction.actual_ev_release[
                                         'releases'][0]['bids']))
                    print("Expected bids object")
