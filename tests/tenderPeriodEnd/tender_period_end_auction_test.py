...
from tests.utils.functions import time_bot, is_it_uuid, compare_actual_result_and_expected_result
...
class TestCreateBid:
    ...
    #               "on the flow ´Is tenderPeriodExpired -> True -> Are there bids for opening? -> False -> "
    ...
    #                 else:
    #                     raise Exception(
    #                         "actual_ev_release['releases'][0]['awards'][1]['id'] must be uuid version 4")
    #             except Exception:
...
# ------------------------------------------------------------------------------------------------------------------
    ...
    def test_check_result_of_sending_the_request_two(self):
        ...
        with allure.step('# 10. Authorization platform one: create second Bid'):
            """
            Tender platform authorization for create contract notice process.
            As result get Tender platform's access token and process operation-id.
            """
        ...
        #                     for i in GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0][
        #                         'bids']['details']:
        #                         for i_1 in i:
        #                             if i_1 == "tenderers":
        ...
        #                 raise Exception("Error into comparing bids")
        #             elif GlobalClassTenderPeriodEndAuction.actual_ev_release['releases'][0]['tender'][
